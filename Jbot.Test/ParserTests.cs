...
public class ParserTests
{
    ...
    #region Top-level
    [Test] public void TestParserValidation_TopLevel_UnexpectedSymbol() => 
        TestInvalid("123");
    
    [Test] public void TestParserValidation_DocumentAttrib_MissingAttributes() => 
        TestInvalid("attrib;");
    [Test] public void TestParserValidation_DocumentAttrib_MissingSemicolon() => 
        TestInvalid("attrib attr1 version");
    
    [Test] public void TestParserValidation_Version_MissingNumber() => 
        TestInvalid("version;");
    [Test] public void TestParserValidation_Version_MissingSemicolon() => 
        TestInvalid("version 1 attrib");
    #endregion
    
    #region Objects
    [Test] public void TestParserValidation_Object_MissingStartBrace() => 
        TestInvalid("object O }");
    [Test] public void TestParserValidation_Object_MissingEndBrace() => 
        TestInvalid("object O { object O2 { }");
    [Test] public void TestParserValidation_Object_UnexpectedSymbol() => 
        TestInvalid("object O { version }");
    
    [Test] public void TestParserValidation_Object_MissingName() => 
        TestInvalid("object #1 { }");
    [Test] public void TestParserValidation_ObjectId_MissingNumber() => 
        TestInvalid("object O # { }");
    
    [Test] public void TestParserValidation_ObjectAttrib_MissingSemicolon() => 
        TestInvalid("object O { attrib a }");
    [Test] public void TestParserValidation_ObjectBind_MissingTarget() => 
        TestInvalid("object O { bind ; }");
    [Test] public void TestParserValidation_ObjectBind_MissingSemicolon() => 
        TestInvalid("object O { bind a.b }");
    #endregion
    
    #region Fields (short-form)
    [Test] public void TestParserValidation_Field_MissingName() => 
        TestInvalid("object O { field ; }");
    [Test] public void TestParserValidation_Field_UnexpectedSymbol() => 
        TestInvalid("object O { field f version }");
    [Test] public void TestParserValidation_FieldId_MissingNumber() => 
        TestInvalid("object O { field f #; }");
    
    [Test] public void TestParserValidation_FieldType_MissingType() => 
        TestInvalid("object O { field f type ; }");
    [Test] public void TestParserValidation_FieldType_TrailingComma() => 
        TestInvalid("object O { field f type t, ; }");
    
    [Test] public void TestParserValidation_FieldAllows_MissingObject() => 
        TestInvalid("object O { field f allows ; }");
    [Test] public void TestParserValidation_FieldAllows_TrailingComma() => 
        TestInvalid("object O { field f allows t1,t2, ; }");
    
    [Test] public void TestParserValidation_FieldBind_MissingTarget() => 
        TestInvalid("object O { field f $ ; }");
    #endregion
    
    #region Fields (long-form)
    [Test] public void TestParserValidation_LongField_UnexpectedSymbol() => 
        TestInvalid("object O { field f { version } }");
    [Test] public void TestParserValidation_LongField_MissingBrace() => 
        TestInvalid("object O { field f { type t;");
    
    [Test] public void TestParserValidation_LongFieldBind_MissingDollar() => 
        TestInvalid("object O { field f { bind target; } }");
    [Test] public void TestParserValidation_LongFieldBind_MissingTarget() => 
        TestInvalid("object O { field f { bind $; } }");
    [Test] public void TestParserValidation_LongFieldBind_MissingSemicolon() => 
        TestInvalid("object O { field f { bind $b } }");
    
    [Test] public void TestParserValidation_LongFieldType_MissingSemicolon() => 
        TestInvalid("object O { field f { type t } }");
    [Test] public void TestParserValidation_LongFieldType_MissingTypeName() => 
        TestInvalid("object O { field f { type ; } }");
    [Test] public void TestParserValidation_LongFieldType_TrailingComma() => 
        TestInvalid("object O { field f { type t, ; } }");
    
    [Test] public void TestParserValidation_LongFieldAllows_MissingSemicolon() => 
        TestInvalid("object O { field f { allows o } }");
    [Test] public void TestParserValidation_LongFieldAllows_MissingObject() => 
        TestInvalid("object O { field f { allows ; } }");
    
    [Test] public void TestParserValidation_LongFieldAttrib_MissingSemicolon() => 
        TestInvalid("object O { field f { attrib a } }");
    [Test] public void TestParserValidation_LongFieldAttrib_MissingAttribute() => 
